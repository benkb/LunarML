...
sig
  ...
  | PlCallOp (* value argument: function, arguments *)
  | PlMethodOp (* value argument: object, name, arguments *)
  | PlNewOp (* value argument: constructor, arguments *)
...
struct
  ...
  struct
    ...
    fun print_PrimOp (IntConstOp x) = "IntConstOp " ^ IntInf.toString x
      ...
      | print_PrimOp PlCallOp = "PlCallOp"
      | print_PrimOp PlMethodOp = "PlMethodOp"
      | print_PrimOp PlNewOp = "PlNewOp"
