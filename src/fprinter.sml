...
struct
  ...
  fun doPrimOp (F.IntConstOp x) =
    ...
    | doPrimOp F.PlCallOp = [P.Fragment "PlCall"]
    | doPrimOp F.PlMethodOp = [P.Fragment "PlMethod"]
    | doPrimOp F.PlNewOp = [P.Fragment "PlNew"]
    | doPrimOp F.LuaCallOp = [P.Fragment "LuaCall"]
    | doPrimOp F.LuaCall1Op = [P.Fragment "LuaCall1"]
    | doPrimOp F.LuaCall2Op = [P.Fragment "LuaCall2"]
    | doPrimOp F.LuaCall3Op = [P.Fragment "LuaCall3"]
    | doPrimOp (F.LuaMethodOp _) = [P.Fragment "LuaMethod"]
    | doPrimOp (F.LuaMethod1Op _) = [P.Fragment "LuaMethod1"]
    | doPrimOp (F.LuaMethod2Op _) = [P.Fragment "LuaMethod2"]
    | doPrimOp (F.LuaMethod3Op _) = [P.Fragment "LuaMethod3"]
