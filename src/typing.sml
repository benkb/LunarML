...
sig
  ...
  val primTyName_Perl_value: TypedSyntax.TyName
  ...
  val primTy_Perl_value: TypedSyntax.Ty
...
struct
  ...
  val primTyName_Perl_value = TypedSyntax.MkTyName ("Perl.value", 18)
  ...
  val primTy_Perl_value =
    TypedSyntax.TyCon (SourcePos.nullSpan, [], primTyName_Perl_value)
  val primTy_int32 =
  ...
  structure TypeOfPrimitives =
    TypeOfPrimitives
      (type ty = TypedSyntax.Ty
       ...
       val PerlValue = primTy_Perl_value
       fun refOf ty =
