...
sig
  ...
  val VId_Perl_undefined: TypedSyntax.VId
  val VId_Perl_null: TypedSyntax.VId
  val VId_Perl_function: TypedSyntax.VId
  val VId_Perl_encodeUtf8: TypedSyntax.VId
  val VId_Perl_decodeUtf8: TypedSyntax.VId
...
struct
  ...
  (* Perl interface *)
  val VId_Perl_undefined = newVId "_Prim.Perl.undefined"
  val VId_Perl_null = newVId "_Prim.Perl.null"
  val VId_Perl_function = newVId "_Prim.Perl.function"
  val VId_Perl_encodeUtf8 = newVId "_Prim.Perl.encodeUtf8"
  val VId_Perl_decodeUtf8 = newVId "_Prim.Perl.decodeUtf8"
    ...
    in
      { valMap = List.foldl (Syntax.VIdMap.unionWith #2) Syntax.VIdMap.empty
          ...
          , List.foldl
              ...
              , ( "_Prim.Perl.undefined"
                , VId_Perl_undefined
                , TypeScheme ([], primTy_Perl_value)
                )
              , ( "_Prim.Perl.null"
                , VId_Perl_null
                , TypeScheme ([], primTy_Perl_value)
              ...
              , ( "_Prim.Perl.function"
                ...
                , TypeScheme
                    ( []
                    , (vectorOf primTy_Perl_value --> primTy_Perl_value)
                      --> primTy_Perl_value
                    )
                )
              , ( "_Prim.Perl.encodeUtf8"
                , VId_Perl_encodeUtf8
                , TypeScheme ([], primTy_string16 --> primTy_string)
                )
              , ( "_Prim.Perl.decodeUtf8"
                , VId_Perl_decodeUtf8
                , TypeScheme ([], primTy_string --> primTy_string16)
                )
      ...
      , tyConMap =
          List.foldl
            ...
            , ( "_Prim.Perl.value"
              , { typeFunction = TypeFunction ([], primTy_Perl_value)
                , valEnv = emptyValEnv
                }
              )
