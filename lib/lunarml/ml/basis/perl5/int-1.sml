...
fun fmt StringCvt.BIN x = let val s = if x >= 0 then
                                          Perl.unsafeFromValue (Perl.method (Perl.fromInt x, "toString") #[Perl.fromInt 2])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.fromInt x), "toString") #[Perl.fromInt 2]))
                          in Perl.encodeUtf8 s
                          end
  | fmt StringCvt.OCT x = let val s = if x >= 0 then
                                          Perl.unsafeFromValue (Perl.method (Perl.fromInt x, "toString") #[Perl.fromInt 8])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.fromInt x), "toString") #[Perl.fromInt 8]))
                          in Perl.encodeUtf8 s
                          end
  | fmt StringCvt.DEC x = let val s = if x >= 0 then
                                          Perl.unsafeFromValue (Perl.method (Perl.fromInt x, "toString") #[])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.fromInt x), "toString") #[]))
                          in Perl.encodeUtf8 s
                          end
  | fmt StringCvt.HEX x = let val s = if x >= 0 then
                                          Perl.unsafeFromValue (Perl.method (Perl.fromInt x, "toString") #[Perl.fromInt 16])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.fromInt x), "toString") #[Perl.fromInt 16]))
