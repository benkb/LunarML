...
type value = _Prim.Perl.value
val undefined = _Prim.Perl.undefined
val null = _Prim.Perl.null
fun call f args = _primCall "Perl.call" (f, args)
fun new ctor args = _primCall "Perl.new" (ctor, args)
fun method (obj, name) args = _primCall "Perl.method" (obj, name, args)
val function = _Prim.Perl.function
val encodeUtf8 = _Prim.Perl.encodeUtf8
val decodeUtf8 = _Prim.Perl.decodeUtf8
...
fun sub (obj, key) = _primCall "Perl.sub" (obj, key)
fun field (obj, key : WideString.string) = _primCall "Perl.sub" (obj, fromWideString key)
fun set (obj, key, value) = _primCall "Perl.set" (obj, key, value)
fun setField (obj, key, value) = _primCall "Perl.set" (obj, fromWideString key, value)
fun global name = _primCall "Perl.global" (name)
fun setGlobal (name, value) = _primCall "Perl.setGlobal" (name, value)
fun isFalsy x = _primCall "Perl.isFalsy" (x)
fun x + y = _primCall "Perl.+" (x, y)
fun x - y = _primCall "Perl.-" (x, y)
fun x * y = _primCall "Perl.*" (x, y)
fun x / y = _primCall "Perl./" (x, y)
fun % (x, y) = _primCall "Perl.%" (x, y)
fun negate x = _primCall "Perl.negate" (x)
fun andb (x, y) = _primCall "Perl.andb" (x, y)
fun orb (x, y) = _primCall "Perl.orb" (x, y)
fun xorb (x, y) = _primCall "Perl.xorb" (x, y)
fun notb x = _primCall "Perl.notb" (x)
fun << (x, y) = _primCall "Perl.<<" (x, y)
fun >> (x, y) = _primCall "Perl.>>" (x, y)
fun >>> (x, y) = _primCall "Perl.>>>" (x, y)
fun === (x, y) = _primCall "Perl.===" (x, y)
...
fun x >= y = _primCall "Perl.>=" (x, y)
fun ** (x, y) = _primCall "Perl.**" (x, y)
fun typeof x = _primCall "Perl.typeof" (x)
