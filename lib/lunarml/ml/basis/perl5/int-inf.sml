...
fun toReal (x : int) : real = Perl.unsafeFromValue (Perl.call Perl.Lib.Number #[Perl.unsafeToValue x])
fun fromIntegralReal (x : real) : int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt #[Perl.fromReal x])
...
fun fmt StringCvt.BIN (x : int) = let val s = if GE (x, 0) then
                                                  Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue x, "toString") #[Perl.fromInt 2])
                                              else
                                                  WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.unsafeToValue x), "toString") #[Perl.fromInt 2]))
                                  in Perl.encodeUtf8 s
                                  end
  | fmt StringCvt.OCT x = let val s = if GE (x, 0) then
                                          Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue x, "toString") #[Perl.fromInt 8])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.unsafeToValue x), "toString") #[Perl.fromInt 8]))
                          in Perl.encodeUtf8 s
                          end
  | fmt StringCvt.DEC x = let val s = if GE (x, 0) then
                                          Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue x, "toString") #[])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.unsafeToValue x), "toString") #[]))
                          in Perl.encodeUtf8 s
                          end
  | fmt StringCvt.HEX x = let val s = if GE (x, 0) then
                                          Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue x, "toString") #[Perl.fromInt 16])
                                      else
                                          WideString.^ ("~", Perl.unsafeFromValue (Perl.method (Perl.negate (Perl.unsafeToValue x), "toString") #[Perl.fromInt 16]))
...
fun pow (x : int, y : Int.int) : int = if y < 0 then
                                           ...
                                           let val y = fromInt y
                                           in Perl.unsafeFromValue (Perl.** (Perl.unsafeToValue x, Perl.unsafeToValue y))
                                           end
...
fun << (x : int, y : Word.word) : int = Perl.unsafeFromValue (Perl.<< (Perl.unsafeToValue x, Perl.call Perl.Lib.BigInt #[Perl.fromWord y]))
fun ~>> (x : int, y : Word.word) : int = Perl.unsafeFromValue (Perl.>> (Perl.unsafeToValue x, Perl.call Perl.Lib.BigInt #[Perl.fromWord y]))
val op < = LT
val op <= = LE
val op > = GT
