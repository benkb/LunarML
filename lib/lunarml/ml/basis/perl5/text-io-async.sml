local
                                                                                        ...
                                                                                        let fun doRead () : string list
                                                                                                = let val chunk = Perl.method (stream, "read") #[]
                                                                                                  in if Perl.=== (chunk, Perl.null) then
                                                                                                         ...
                                                                                                         let val chunk : string = Perl.unsafeFromValue chunk (* Buffer as string *)
    ...
    structure Instream : sig
                  ...
                  val openReadable : Perl.value * string -> instream
              end = struct
    type elem = char
    type vector = string
...
fun openIn path = mkInstream (StreamIO.openReadable (Perl.call createReadStream #[Perl.unsafeToValue path (* as Buffer? *)], path))
...
fun openOut path = let val writable = Perl.call createWriteStream #[Perl.unsafeToValue path (* as Buffer? *)]
...
fun openAppend path = let val options = Perl.newObject ()
                          ...
                          val writable = Perl.call createWriteStream #[Perl.unsafeToValue path (* as Buffer? *), options]
                      in mkOutstream (Outstream.fromWritable (Writable.fromValue writable, IO.BLOCK_BUF, path))
                      end
