local
    fun BigIntToWord (x : IntInf.int) : word = Perl.unsafeFromValue (Perl.call Perl.Lib.Number #[Perl.unsafeToValue x])
    fun WordToBigInt (x : word) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt #[Perl.unsafeToValue x])
    fun asBigInt8 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asIntN #[Perl.fromInt 8, Perl.unsafeToValue x])
    fun asBigUint8 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asUintN #[Perl.fromInt 8, Perl.unsafeToValue x])
    fun asBigInt16 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asIntN #[Perl.fromInt 16, Perl.unsafeToValue x])
    fun asBigUint16 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asUintN #[Perl.fromInt 16, Perl.unsafeToValue x])
    fun asBigInt32 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asIntN #[Perl.fromInt 32, Perl.unsafeToValue x])
    fun asBigUint32 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asUintN #[Perl.fromInt 32, Perl.unsafeToValue x])
    fun asBigInt64 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asIntN #[Perl.fromInt 64, Perl.unsafeToValue x])
    fun asBigUint64 (x : IntInf.int) : IntInf.int = Perl.unsafeFromValue (Perl.call Perl.Lib.BigInt.asUintN #[Perl.fromInt 64, Perl.unsafeToValue x])
