...
fun contains (s : WideString.string) (c : WideChar.char) : bool
    = Perl.unsafeFromValue (Perl.method (Perl.fromWideString s, "includes") #[Perl.fromWideString (WideString.str c)])
...
fun sub (s : WideString.string, i : int) : WideChar.char = Perl.unsafeFromValue (Perl.method (Perl.fromWideString s, "charCodeAt") #[Perl.fromInt i])
end;
...
fun substring (s : WideString.string, i : int, j : int) : WideString.string
    = if i < 0 orelse j < 0 orelse WideString.size s < i + j then
          ...
          Perl.unsafeFromValue (Perl.method (Perl.fromWideString s, "substring") #[Perl.fromInt i, Perl.fromInt (i + j)])
fun extract (s : WideString.string, i : int, NONE : int option) : WideString.string
    = if i < 0 orelse WideString.size s < i then
          raise Subscript
      else
          Perl.unsafeFromValue (Perl.method (Perl.fromWideString s, "substring") #[Perl.fromInt i])
  | extract (s, i, SOME j) = substring (s, i, j)
fun concat (l : WideString.string list) : WideString.string
    = let val v = Vector.fromList l
      in Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue v, "join") #[Perl.fromWideString ""])
      end
fun concatWith (s : WideString.string) (l : WideString.string list) : WideString.string
    = let val v = Vector.fromList l
      in Perl.unsafeFromValue (Perl.method (Perl.unsafeToValue v, "join") #[Perl.fromWideString s])
      end
...
fun isSubstring needle haystack : bool = Perl.unsafeFromValue (Perl.method (Perl.fromWideString haystack, "includes") #[Perl.fromWideString needle])
